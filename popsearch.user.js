...
// @connect					deepl.com
// @charset					UTF-8
// @supportURL				https://github.com/821869798/popsearch/issues
// @updateURL				https://raw.githubusercontent.com/821869798/popsearch/main/popsearch.user.js
// @downloadURL				https://raw.githubusercontent.com/821869798/popsearch/main/popsearch.user.js
// ==/UserScript==
...
popData = {
  ...
  icons: {
    ...
    baidufyIcon : "data:image/png;base64,",
    githubIcon : "data:image/png;base64,",
    potIcon : "data:image/png;base64,",
...
popData.engines = [{
  ...
  href: 'https://wikipedia.org/w/index.php?search=${text}'
    ...
    id: "Github_st",
    title: "Search with Github repositories",
    description: "GitHub搜索 / Search with GitHub",
    defaultState: 1,
    src: popData.icons.githubIcon,
    href: 'https://github.com/search?q=${text}&type=repositories'
},{
    id: "pot_translate",
    title: "通过pot翻译",
    description: "通过pot翻译",
    defaultState: 1,
    src: popData.icons.potIcon,
    action: function () {
        GM_xmlhttpRequest({
            method: "POST",
            url: "http://127.0.0.1:60828/translate",
            data: popData.rawText
          });
      }
}];
